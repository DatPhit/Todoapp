...
export const ListJob: ListJobProps[] = [
    ...
    },
    {
        ...
        task: 'Phân tích dữ liệu thống kê',
        status: 'Done',
        deadline: '2023-07-10 09:00',
        priority: false,
        steps: [
            { stt: 'Done', name: 'Thu thập dữ liệu từ các nguồn khác nhau' },
            { stt: 'Done', name: 'Xử lý và chuẩn hóa dữ liệu' },
            { stt: 'Done', name: 'Phân tích dữ liệu và tạo báo cáo' },
            { stt: 'Done', name: 'Đánh giá và rút ra kết luận' },
        ],
        description: 'Phân tích dữ liệu thống kê về doanh số bán hàng',
        workplace: 'Bách khoa',
        type: 'Việc nhóm',
        groupname: 'Nhóm Nhật ngành',
    },
